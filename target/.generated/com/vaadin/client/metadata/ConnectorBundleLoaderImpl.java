...
public class ConnectorBundleLoaderImpl extends com.vaadin.client.metadata.ConnectorBundleLoader {
  public void init() {
    addAsyncBlockLoader(new AsyncBundleLoader("__eager", new String[] {"com.vaadin.ui.Image","com.vaadin.ui.TextArea","com.vaadin.ui.Video","com.vaadin.ui.Window","com.vaadin.ui.ListSelect","com.vaadin.ui.ProgressIndicator","com.vaadin.ui.GridLayout","com.vaadin.ui.AbstractJavaScriptComponent","com.vaadin.ui.OptionGroup","com.vaadin.ui.TabSheet","com.vaadin.ui.FormLayout","com.vaadin.ui.CustomComponent","com.vaadin.ui.InlineDateField","com.vaadin.ui.Accordion","com.vaadin.ui.Slider","com.vaadin.server.BrowserWindowOpener","com.vaadin.ui.PasswordField","com.vaadin.ui.Button","com.vaadin.ui.BrowserFrame","com.vaadin.ui.CustomField","com.vaadin.ui.Link","com.vaadin.ui.MenuBar","com.vaadin.server.AbstractJavaScriptExtension","com.vaadin.ui.NativeButton","com.vaadin.ui.UI","com.vaadin.ui.Form","com.vaadin.ui.CssLayout","com.vaadin.ui.Label","com.vaadin.ui.Embedded","com.vaadin.ui.TwinColSelect","com.vaadin.ui.Upload","com.vaadin.ui.NativeSelect","com.vaadin.ui.HorizontalLayout","com.vaadin.ui.Flash","com.vaadin.ui.JavaScript","com.vaadin.ui.PopupView","com.vaadin.ui.HorizontalSplitPanel","com.vaadin.ui.VerticalSplitPanel","com.vaadin.ui.Audio","com.vaadin.ui.DragAndDropWrapper","com.vaadin.ui.TextField","com.vaadin.ui.AbsoluteLayout","com.vaadin.ui.CustomLayout","com.vaadin.ui.Tree","com.vaadin.ui.Panel","com.vaadin.server.FileDownloader","com.vaadin.ui.TreeTable","com.vaadin.ui.VerticalLayout","com.vaadin.ui.CheckBox","com.vaadin.ui.DateField","com.vaadin.ui.ComboBox","com.vaadin.ui.Table",}) {
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load1() {
            ...
            store.setProperties(com.vaadin.shared.ui.BrowserWindowOpenerState.class, new String[] {"errorMessage", "uriFragment", "parameters", "width", "target", "immediate", "description", "readOnly", "resources", "caption", "features", "primaryStyleName", "height", "styles", "registeredEventListeners", "enabled", "id", });
            store.setProperties(com.vaadin.shared.ui.checkbox.CheckBoxState.class, new String[] {"primaryStyleName", "tabIndex", "modified", "registeredEventListeners", "id", "readOnly", "width", "hideErrors", "styles", "required", "enabled", "checked", "errorMessage", "propertyReadOnly", "immediate", "caption", "description", "height", "resources", });
            store.setProperties(com.vaadin.shared.MouseEventDetails.class, new String[] {"altKey", "ctrlKey", "shiftKey", "clientY", "clientX", "relativeX", "type", "metaKey", "relativeY", "button", });
            store.setProperties(com.vaadin.shared.ui.treetable.TreeTableState.class, new String[] {"enabled", "errorMessage", "hideErrors", "tabIndex", "styles", "primaryStyleName", "immediate", "required", "height", "width", "id", "registeredEventListeners", "modified", "caption", "resources", "propertyReadOnly", "readOnly", "description", });
            store.setProperties(com.vaadin.shared.ui.image.ImageState.class, new String[] {"readOnly", "width", "primaryStyleName", "alternateText", "description", "id", "immediate", "errorMessage", "caption", "styles", "height", "enabled", "registeredEventListeners", "resources", });
            ...
            store.setProperties(com.vaadin.shared.ui.gridlayout.GridLayoutState.ChildComponentData.class, new String[] {"column2", "column1", "row1", "alignment", "row2", });
            store.setProperties(com.vaadin.shared.ui.flash.FlashState.class, new String[] {"styles", "errorMessage", "height", "width", "description", "codebase", "id", "registeredEventListeners", "enabled", "embedParams", "classId", "standby", "readOnly", "codetype", "primaryStyleName", "archive", "caption", "alternateText", "resources", "immediate", });
            store.setProperties(com.vaadin.shared.ui.tree.TreeState.class, new String[] {"styles", "propertyReadOnly", "readOnly", "enabled", "immediate", "tabIndex", "registeredEventListeners", "id", "caption", "primaryStyleName", "modified", "height", "width", "hideErrors", "required", "resources", "errorMessage", "description", });
            store.setProperties(com.vaadin.shared.ui.csslayout.CssLayoutState.class, new String[] {"height", "primaryStyleName", "width", "description", "id", "styles", "readOnly", "resources", "caption", "enabled", "errorMessage", "immediate", "registeredEventListeners", "childCss", });
            store.setProperties(com.vaadin.shared.ui.video.VideoState.class, new String[] {"readOnly", "resources", "sources", "height", "id", "sourceTypes", "immediate", "enabled", "htmlContentAllowed", "styles", "caption", "altText", "muted", "primaryStyleName", "showControls", "errorMessage", "width", "autoplay", "description", "registeredEventListeners", });
            store.setProperties(com.vaadin.shared.ui.link.LinkState.class, new String[] {"enabled", "width", "resources", "registeredEventListeners", "caption", "primaryStyleName", "immediate", "readOnly", "errorMessage", "height", "styles", "description", "id", });
            store.setProperties(com.vaadin.shared.ui.textfield.AbstractTextFieldState.class, new String[] {"description", "readOnly", "required", "enabled", "columns", "registeredEventListeners", "propertyReadOnly", "width", "styles", "caption", "text", "tabIndex", "height", "immediate", "primaryStyleName", "maxLength", "id", "inputPrompt", "hideErrors", "modified", "resources", "errorMessage", });
            store.setProperties(com.vaadin.shared.ui.menubar.MenuBarState.class, new String[] {"width", "resources", "errorMessage", "id", "immediate", "caption", "primaryStyleName", "enabled", "height", "styles", "registeredEventListeners", "readOnly", "description", });
            store.setProperties(com.vaadin.shared.ui.splitpanel.VerticalSplitPanelState.class, new String[] {"id", "immediate", "readOnly", "resources", "primaryStyleName", "width", "enabled", "description", "height", "styles", "firstChild", "caption", "errorMessage", "splitterState", "registeredEventListeners", "secondChild", });
            store.setProperties(com.vaadin.shared.AbstractComponentState.class, new String[] {"resources", "caption", "enabled", "immediate", "height", "styles", "id", "errorMessage", "readOnly", "registeredEventListeners", "width", "description", "primaryStyleName", });
            store.setProperties(com.vaadin.shared.ui.button.ButtonState.class, new String[] {"styles", "immediate", "errorMessage", "height", "htmlContentAllowed", "tabIndex", "id", "disableOnClick", "readOnly", "resources", "clickShortcutKeyCode", "width", "enabled", "registeredEventListeners", "description", "primaryStyleName", "caption", });
            store.setProperties(com.vaadin.shared.ui.popupview.PopupViewState.class, new String[] {"id", "primaryStyleName", "resources", "width", "readOnly", "description", "height", "caption", "styles", "enabled", "hideOnMouseOut", "html", "registeredEventListeners", "immediate", "errorMessage", });
            ...
            store.setProperties(com.vaadin.shared.ui.JavaScriptComponentState.class, new String[] {"readOnly", "height", "registeredEventListeners", "primaryStyleName", "callbackNames", "styles", "id", "description", "caption", "enabled", "width", "rpcInterfaces", "immediate", "resources", "errorMessage", });
            store.setProperties(com.vaadin.shared.ui.gridlayout.GridLayoutState.class, new String[] {"immediate", "resources", "columns", "width", "styles", "errorMessage", "rows", "childData", "readOnly", "caption", "spacing", "id", "enabled", "height", "marginsBitmask", "description", "registeredEventListeners", "primaryStyleName", });
            store.setProperties(com.vaadin.shared.ui.table.TableState.class, new String[] {"resources", "propertyReadOnly", "height", "description", "modified", "primaryStyleName", "styles", "tabIndex", "registeredEventListeners", "hideErrors", "enabled", "immediate", "required", "readOnly", "caption", "errorMessage", "width", "id", });
            store.setProperties(com.vaadin.shared.ui.orderedlayout.AbstractOrderedLayoutState.class, new String[] {"id", "height", "primaryStyleName", "width", "resources", "marginsBitmask", "childData", "description", "styles", "errorMessage", "registeredEventListeners", "caption", "immediate", "spacing", "readOnly", "enabled", });
            store.setProperties(com.vaadin.shared.JavaScriptExtensionState.class, new String[] {"callbackNames", "enabled", "registeredEventListeners", "rpcInterfaces", "resources", });
            store.setProperties(com.vaadin.shared.extension.javascriptmanager.JavaScriptManagerState.class, new String[] {"resources", "names", "registeredEventListeners", "enabled", });
            store.setProperties(com.vaadin.shared.ui.slider.SliderState.class, new String[] {"required", "tabIndex", "resources", "styles", "id", "primaryStyleName", "description", "height", "width", "modified", "orientation", "registeredEventListeners", "hideErrors", "propertyReadOnly", "errorMessage", "immediate", "resolution", "readOnly", "enabled", "minValue", "caption", "maxValue", "value", });
            store.setProperties(com.vaadin.shared.ui.customlayout.CustomLayoutState.class, new String[] {"caption", "immediate", "errorMessage", "childLocations", "id", "templateName", "registeredEventListeners", "enabled", "height", "description", "primaryStyleName", "width", "resources", "readOnly", "styles", "templateContents", });
            store.setProperties(com.vaadin.shared.ui.absolutelayout.AbsoluteLayoutState.class, new String[] {"connectorToCssPosition", "errorMessage", "immediate", "styles", "readOnly", "primaryStyleName", "description", "height", "resources", "enabled", "registeredEventListeners", "id", "caption", "width", });
            store.setProperties(com.vaadin.shared.ui.combobox.ComboBoxState.class, new String[] {"registeredEventListeners", "modified", "description", "immediate", "tabIndex", "height", "id", "width", "resources", "errorMessage", "hideErrors", "readOnly", "propertyReadOnly", "styles", "required", "primaryStyleName", "enabled", "caption", });
            store.setProperties(com.vaadin.shared.ui.splitpanel.AbstractSplitPanelState.SplitterState.class, new String[] {"maxPosition", "minPositionUnit", "locked", "maxPositionUnit", "positionReversed", "minPosition", "position", "positionUnit", });
            store.setProperties(com.vaadin.shared.ui.window.WindowState.class, new String[] {"tabIndex", "primaryStyleName", "modal", "immediate", "scrollLeft", "scrollTop", "styles", "caption", "centered", "height", "enabled", "resizeLazy", "resizable", "id", "positionX", "description", "positionY", "registeredEventListeners", "resources", "errorMessage", "width", "readOnly", "draggable", });
            store.setProperties(com.vaadin.shared.ui.tabsheet.TabsheetState.class, new String[] {"height", "readOnly", "width", "registeredEventListeners", "errorMessage", "description", "enabled", "immediate", "id", "caption", "primaryStyleName", "resources", "styles", });
            store.setProperties(com.vaadin.shared.ui.orderedlayout.VerticalLayoutState.class, new String[] {"styles", "resources", "caption", "errorMessage", "width", "readOnly", "id", "primaryStyleName", "marginsBitmask", "spacing", "immediate", "height", "childData", "description", "enabled", "registeredEventListeners", });
            store.setProperties(com.vaadin.shared.ui.AbstractMediaState.class, new String[] {"primaryStyleName", "altText", "htmlContentAllowed", "resources", "registeredEventListeners", "styles", "sources", "height", "sourceTypes", "enabled", "readOnly", "muted", "width", "showControls", "immediate", "errorMessage", "caption", "description", "autoplay", "id", });
            load2();
          }
          private void load2() {
            store.setProperties(com.vaadin.shared.ui.datefield.PopupDateFieldState.class, new String[] {"caption", "registeredEventListeners", "errorMessage", "propertyReadOnly", "readOnly", "resources", "id", "required", "enabled", "styles", "height", "hideErrors", "immediate", "textFieldEnabled", "modified", "tabIndex", "description", "width", "primaryStyleName", });
            store.setProperties(com.vaadin.shared.ui.panel.PanelState.class, new String[] {"scrollLeft", "caption", "resources", "styles", "id", "readOnly", "tabIndex", "width", "registeredEventListeners", "scrollTop", "enabled", "immediate", "description", "errorMessage", "height", "primaryStyleName", });
            store.setProperties(com.vaadin.shared.ui.embedded.EmbeddedState.class, new String[] {"registeredEventListeners", "immediate", "description", "readOnly", "caption", "width", "styles", "primaryStyleName", "enabled", "resources", "height", "errorMessage", "alternateText", "id", });
            store.setProperties(com.vaadin.shared.ui.label.LabelState.class, new String[] {"enabled", "description", "id", "primaryStyleName", "caption", "contentMode", "readOnly", "resources", "immediate", "styles", "registeredEventListeners", "height", "width", "errorMessage", "text", });
            store.setProperties(com.vaadin.shared.ui.twincolselect.TwinColSelectState.class, new String[] {"styles", "description", "modified", "registeredEventListeners", "enabled", "resources", "width", "id", "caption", "tabIndex", "required", "immediate", "errorMessage", "propertyReadOnly", "readOnly", "primaryStyleName", "hideErrors", "height", });
            store.setProperties(com.vaadin.shared.ui.ui.UIState.class, new String[] {"id", "caption", "width", "enabled", "primaryStyleName", "tabIndex", "height", "readOnly", "styles", "registeredEventListeners", "errorMessage", "immediate", "resources", "description", });
            store.setProperties(com.vaadin.shared.ui.orderedlayout.HorizontalLayoutState.class, new String[] {"id", "width", "immediate", "childData", "enabled", "marginsBitmask", "description", "resources", "caption", "height", "styles", "errorMessage", "readOnly", "primaryStyleName", "spacing", "registeredEventListeners", });
            store.setProperties(com.vaadin.shared.ui.datefield.InlineDateFieldState.class, new String[] {"immediate", "primaryStyleName", "resources", "hideErrors", "height", "styles", "errorMessage", "caption", "registeredEventListeners", "required", "propertyReadOnly", "enabled", "id", "modified", "description", "readOnly", "tabIndex", "width", });
            store.setProperties(com.vaadin.shared.ui.optiongroup.OptionGroupState.class, new String[] {"styles", "enabled", "hideErrors", "tabIndex", "readOnly", "propertyReadOnly", "modified", "errorMessage", "id", "immediate", "primaryStyleName", "width", "description", "registeredEventListeners", "caption", "required", "resources", "height", });
            store.setProperties(com.vaadin.shared.ui.progressindicator.ProgressIndicatorState.class, new String[] {"height", "styles", "pollingInterval", "resources", "immediate", "enabled", "state", "id", "registeredEventListeners", "propertyReadOnly", "modified", "description", "errorMessage", "caption", "hideErrors", "tabIndex", "width", "primaryStyleName", "readOnly", "indeterminate", "required", });
            store.setProperties(com.vaadin.shared.ui.button.NativeButtonState.class, new String[] {"width", "errorMessage", "disableOnClick", "caption", "resources", "height", "styles", "registeredEventListeners", "tabIndex", "clickShortcutKeyCode", "id", "htmlContentAllowed", "readOnly", "enabled", "immediate", "description", "primaryStyleName", });
            store.setProperties(com.vaadin.shared.ui.form.FormState.class, new String[] {"footer", "readOnly", "registeredEventListeners", "errorMessage", "primaryStyleName", "propertyReadOnly", "height", "resources", "width", "immediate", "description", "enabled", "layout", "modified", "required", "caption", "hideErrors", "tabIndex", "styles", "id", });
            store.setProperties(com.vaadin.shared.ui.browserframe.BrowserFrameState.class, new String[] {"id", "alternateText", "caption", "registeredEventListeners", "immediate", "styles", "primaryStyleName", "resources", "errorMessage", "enabled", "readOnly", "description", "height", "width", });
            store.setProperties(com.vaadin.shared.AbstractFieldState.class, new String[] {"hideErrors", "styles", "id", "readOnly", "resources", "caption", "primaryStyleName", "description", "errorMessage", "modified", "height", "required", "width", "tabIndex", "enabled", "registeredEventListeners", "propertyReadOnly", "immediate", });
            store.setProperties(com.vaadin.shared.ui.textarea.TextAreaState.class, new String[] {"readOnly", "caption", "text", "required", "wordwrap", "primaryStyleName", "columns", "rows", "inputPrompt", "tabIndex", "description", "maxLength", "propertyReadOnly", "id", "hideErrors", "modified", "width", "height", "enabled", "resources", "immediate", "registeredEventListeners", "errorMessage", "styles", });
            store.setProperties(com.vaadin.shared.ui.splitpanel.HorizontalSplitPanelState.class, new String[] {"errorMessage", "firstChild", "secondChild", "enabled", "splitterState", "caption", "id", "description", "height", "readOnly", "resources", "width", "immediate", "registeredEventListeners", "styles", "primaryStyleName", });
      ...
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        com.google.gwt.core.client.GWT.runAsync(new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load() {
            ...
            store.setProperties(com.vaadin.shared.ui.colorpicker.ColorPickerGradientState.class, new String[] {"bgColor", "primaryStyleName", "height", "caption", "immediate", "enabled", "description", "registeredEventListeners", "id", "styles", "cursorX", "cursorY", "width", "readOnly", "resources", "errorMessage", });
      ...
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        com.google.gwt.core.client.GWT.runAsync(new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load() {
            ...
            store.setProperties(com.vaadin.shared.ui.colorpicker.ColorPickerState.class, new String[] {"width", "errorMessage", "styles", "popupVisible", "description", "resources", "immediate", "primaryStyleName", "color", "id", "readOnly", "enabled", "caption", "showDefaultCaption", "htmlContentAllowed", "height", "registeredEventListeners", });
      ...
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        com.google.gwt.core.client.GWT.runAsync(new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load() {
            ...
            store.setProperties(com.vaadin.shared.ui.colorpicker.ColorPickerGridState.class, new String[] {"registeredEventListeners", "rowCount", "changedX", "changedY", "id", "readOnly", "height", "immediate", "errorMessage", "caption", "changedColor", "styles", "width", "description", "resources", "columnCount", "enabled", "primaryStyleName", });
